...
export default class ProfileHeaderMobile extends React.Component {
	render() {
			...
			<div id="profile-launchpad-header">
				...
				<div className="profile-body-banner">
					...
					<div className="btn-grp grid grid-cols-5 gap-3">
						...
						<button className="btn-gray flex justify-center py-1 rounded-md"><img src="/images/svg/icon-settings.svg" className="mt-1" alt=""/></button>
					</div>
				</div>
			</div>
		);
